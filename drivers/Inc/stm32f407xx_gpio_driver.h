...
typedef struct
{
	GPIO_RegDef_t *pGPIOx;             /*|< This holds the base address of the GPIO port the pin belongs to > */
...
#define GPIO_MODE_IT_FT    4    //Input trigger falling edge trigger - interrupt mode
...
void GPIO_DeInit(GPIO_RegDef_t *pGPIOx); //Set GPIO state to reset settings
